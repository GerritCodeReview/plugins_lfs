...
import static com.googlesource.gerrit.plugins.lfs.LfsAuthToken.LfsAuthTokenVerifier.ISO;
import static com.googlesource.gerrit.plugins.lfs.LfsAuthToken.LfsAuthTokenVerifier.onTime;
...
public class LfsAuthTokenTest {
  ...
  private class TestTokenProessor
      extends LfsAuthToken.LfsAuthTokenProcessor<TestToken> {
  ...
  private class TestTokenVerifier
      extends LfsAuthToken.LfsAuthTokenVerifier<TestToken> {

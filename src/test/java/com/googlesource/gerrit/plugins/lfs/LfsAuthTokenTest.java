...
import static com.googlesource.gerrit.plugins.lfs.LfsDateTime.format;
...
public class LfsAuthTokenTest {
  ...
  public void testExpiredTime() throws Exception {
    ...
    assertThat(onTime(format(now().minusMillis(1)))).isFalse();
  }

  @Test
  public void testOnTime() throws Exception {
    // if there is at least 1ms before there is no timeout
    assertThat(onTime(format(now().plusMillis(1)))).isTrue();
  }

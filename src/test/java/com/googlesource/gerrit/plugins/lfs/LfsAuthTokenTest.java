...
import static com.googlesource.gerrit.plugins.lfs.LfsAuthToken.Verifier.ISO;
...
public class LfsAuthTokenTest {
  ...
  private class TestTokenProessor
      extends LfsAuthToken.Processor<TestToken> {
  ...
  private class TestTokenVerifier
      extends LfsAuthToken.Verifier<TestToken> {

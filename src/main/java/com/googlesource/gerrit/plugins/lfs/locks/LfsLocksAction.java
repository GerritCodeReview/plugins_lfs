...
abstract class LfsLocksAction {
  ...
  protected abstract void authorizeUser(ProjectState state, CurrentUser user) throws LfsUnauthorized;
  ...
  protected void throwUnauthorizedOp(String op, ProjectState control, CurrentUser user) throws LfsUnauthorized {
    String project = control.getName();
    String userName =

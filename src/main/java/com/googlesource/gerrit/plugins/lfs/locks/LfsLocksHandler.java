...
class LfsLocksHandler {
  ...
  private final LoadingCache<Project.NameKey, LfsProjectLocks> projects;

  @Inject
  LfsLocksHandler(PathToLockId toLockId, LoadingCache<Project.NameKey, LfsProjectLocks> projects) {

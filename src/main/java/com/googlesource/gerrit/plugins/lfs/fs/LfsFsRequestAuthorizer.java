...
public class LfsFsRequestAuthorizer {
  ...
  private static class LfsFsAuthToken extends LfsAuthToken {
    ...
    LfsFsAuthToken(String operation, AnyLongObjectId id, Instant issued, int expiresIn) {
      super(issued, expiresIn);
      this.operation = operation;
      this.id = id;
    }

    LfsFsAuthToken(String operation, AnyLongObjectId id, String issued, int expiresIn) {
      super(issued, expiresIn);
      this.operation = operation;
      this.id = id;
    }

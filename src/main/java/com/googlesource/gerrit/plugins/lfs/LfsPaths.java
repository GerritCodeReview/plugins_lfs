...
public final class LfsPaths {
  ...
  public static final String LFS_UNIFIED_PATHS =
      Joiner.on('|').join(LFS_OBJECTS_PATH, LFS_LOCKS_PATH, LFS_VERIFICATION_PATH);
  public static final String URL_REGEX_TEMPLATE = "^(?:/a)?(?:/p/|/)(.+)(?:/info/lfs/)(?:%s)$";
  public static final String URL_REGEX = String.format(URL_REGEX_TEMPLATE, LFS_UNIFIED_PATHS);

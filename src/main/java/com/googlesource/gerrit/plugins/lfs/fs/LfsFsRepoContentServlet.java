...
public class LfsFsRepoContentServlet extends FileLfsServlet {
  public interface Factory {
    LfsFsRepoContentServlet create(LocalLargeFileRepositoryProxy largeFileRepository);
  }

  private static final long serialVersionUID = 1L;

  private final LfsFsRequestAuthorizer authorizer;
  private final LocalLargeFileRepositoryProxy repository;
  private final long timeout;

  @Inject
  public LfsFsRepoContentServlet(
      LfsFsRequestAuthorizer authorizer, @Assisted LocalLargeFileRepositoryProxy repository) {
    super(repository, 0);

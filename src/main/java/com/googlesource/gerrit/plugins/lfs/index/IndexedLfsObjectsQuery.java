...
public class IndexedLfsObjectsQuery extends IndexedQuery<String, LfsData> {

  public IndexedLfsObjectsQuery(Index<String, LfsData> index,
      Predicate<LfsData> pred, QueryOptions opts) throws QueryParseException {

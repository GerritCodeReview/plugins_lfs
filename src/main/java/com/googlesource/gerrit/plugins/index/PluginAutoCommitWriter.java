...
// TODO copy of com.google.gerrit.lucene.AutoCommitWriter
...
public class PluginAutoCommitWriter extends IndexWriter {
  private boolean autoCommit;

  PluginAutoCommitWriter(Directory dir, IndexWriterConfig config)
      throws IOException {
    this(dir, config, false);
  }

  PluginAutoCommitWriter(Directory dir, IndexWriterConfig config, boolean autoCommit)
      throws IOException {
    super(dir, config);

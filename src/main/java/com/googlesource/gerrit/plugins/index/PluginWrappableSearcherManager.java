...
//TODO copy of com.google.gerrit.lucene.WrappableSearcherManager
//should be removed when
//com.googlesource.gerrit.plugins.index.PluginAbstractLuceneIndex<K, V>
//is removed
/**
...
final class PluginWrappableSearcherManager extends ReferenceManager<IndexSearcher> {
   ...
   */
  PluginWrappableSearcherManager(IndexWriter writer, boolean applyAllDeletes, SearcherFactory searcherFactory) throws IOException {
   ...
   * @throws IOException if there is a low-level I/O error
   */
  PluginWrappableSearcherManager(Directory dir, SearcherFactory searcherFactory) throws IOException {
    if (searcherFactory == null) {
      searcherFactory = new SearcherFactory();
    }
    this.searcherFactory = searcherFactory;
   ...
   * @throws IOException if there is a low-level I/O error
   */
  PluginWrappableSearcherManager(DirectoryReader reader, SearcherFactory searcherFactory) throws IOException {
    if (searcherFactory == null) {
      searcherFactory = new SearcherFactory();
    }
    this.searcherFactory = searcherFactory;
